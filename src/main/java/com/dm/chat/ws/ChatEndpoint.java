...
import com.dm.chat.enums.MessageTypeEnum;
...
public class ChatEndpoint {
	...
	public void onMessage(String message, Session session) {
		...
		try {
			...
			msg.setMine(username.equals(toName));
			// 封装发送的消息
			String sendMsg = null;
			try {
			...
			if (target == null) {
				this.session.getBasicRemote().sendText(MessageUtil.getMessage(true, username, "对方不在线"));
			} else {
